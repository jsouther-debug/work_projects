...
class Intersection {
    ...
    Intersection(this.frame, this.material);
...
class Camera {
    var imageSize     = Size2(1, 1);
    var imageDistance = 1.0;
    var eye           = Point(0, 0, 1);
    ...
    Camera.fromJson(JsonLoader loader) {
        imageSize     = loader.loadObject('imageSize',     (d)=>Size2.fromJson(d))     ?? imageSize;
        imageDistance = loader.loadObject('imageDistance', (d)=>NumDouble.fromJson(d)) ?? imageDistance;
