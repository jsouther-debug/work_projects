...
// base in IDA: 0x565058FD5000
// base in Linux w/o ASLR: 0x555555554000
// diff: 0xFB03A81000

// BP in IDA: 0000565058FDCFF7
#define BREAK_POINT_ADDRESS 0x55555555B3A7
#define CLICK_ADDRESS 0x55555555E220
            ...
            if (WSTOPSIG(status) == SIGALRM) {
                ...
                if (first_stop) { // initial trap
                    ...
                    if (ip - 1 == BREAK_POINT_ADDRESS) {
                        ...
                        //save = set_register32(pid, REG_R12, 0);

                        single_step(pid);

                        set_register(pid, REG_R12, 1);
